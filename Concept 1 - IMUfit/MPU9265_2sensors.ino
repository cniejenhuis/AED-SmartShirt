       ...
       if (IMU.accelerationAvailable() && IMU.gyroscopeAvailable() && IMU.magneticFieldAvailable()) 
        {
             ...
             */
                  ...
                  float rollNano, pitchNano, yawNano;
                  ...
                  if (IMU.accelerationAvailable() &&
                    ...
                    // print the yawNano, pitchNano and rollNano
                    rollNano = filter.getRoll();
                    pitchNano = filter.getPitch();
                    yawNano = filter.getYaw();
                    Serial.print("yawNano: ");
                    Serial.println(yawNano);
                    Serial.print("pitchNano: ");
                    Serial.println(pitchNano);
                    Serial.print("rollNano: ");
                    Serial.println(rollNano);
Serial.println();
Serial.println();
Serial.println();
                    }
